<template>
  <div class="relative bg-gray-50 px-6 pt-16 pb-20 lg:px-8 lg:pt-24 lg:pb-28">
    ...
    <div class="relative mx-auto -mt-10 bg-white border border-red-500 max-h-fit overflow-y-scroll">
      ...
      <div class="mx-auto mt-5 grid max-w-lg gap-5 lg:max-w-none lg:grid-cols-8">
        <div v-for="post in posts" :key="post.title" class="flex flex-col overflow-hidden rounded-lg shadow-lg h-72 ">
