                ...
                <div v-if="conditionalStore.matildaSchool.healing1CharmLearned === false" class="mx-3">
                    <button @click="attemptBuyHealing1Charm" class="bg-white border border-gray-500 hover:bg-gray-500 hover:opacity-50"> 
                        <div class="grid grid-cols-2"> 
                            <div class="flex justify-center"> 
                                <img src="../../assets/images/village_magic/Magic_book_1.png" class="" />
                            </div>
                            <div class="mx-2 my-3"> 
                                ...
                                <p>Cost to learn: <br/> 100 coin</p>
                                <p>Minimum Intelligence to learn: <br/> 1</p>
                            </div>                            
                        </div>                        
                    </button>
                </div>
                    ...
                    <button class="bg-white border border-gray-500 hover:bg-gray-500 hover:opacity-50"> 
                        <div class="grid grid-cols-2"> 
                            ...
                            <div class="mx-2 my-3"> 
                                ...
                                <p>Heals between 10 and 25 points, using 1-5 mana</p>
                                <p>Cost: <br/> 100 coin</p>
                                <p>Minimum Intelligence to learn: <br/> 1</p>
                            </div>                            
                        </div>                        
                    </button>                     
...
<script setup> 
    ...
    const welcomeScript = ref(false);
    const insufficicnetFunds = ref(false);
    const insufficientIntel = ref(true);
