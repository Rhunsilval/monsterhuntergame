    ...
    <div class="flex justify-center">
        ...
        <!-- vanishing text if a conversation is started -->
            ...
            <div class="flex justify-center my-4"> 
                <img src="../../assets/images/quests/Pub_scholar.png" class="h-52 rounded-xl border border-gray-500 "/>
            </div>
            ...
            <div >
                ...
                <div v-if="!anyConversation" class="flex justify-center mt-8">
                    ...
                    <div v-else class="grid grid-cols-2 gap-3"> 
                        <button v-if="conditionalStore.conversationsScholar.convo1Available" @click="startConvo1" class="px-2 py-2 border border-gray-500 rounded-xl bg-blue-400 hover:bg-blue-700 hover:text-white">
                            Sure!</button>
                        <button @click="endConversations" class="px-2 py-2 border border-gray-500 rounded-xl bg-gray-400 hover:bg-gray-600 hover:text-white  ">
                            No, thanks.</button>
                    </div>
                ...
                <div v-if="conditionalStore.conversationsScholar.convo1Started"> 
                    <div v-if="conditionalStore.conversationsScholar.convo1Available"> 
                        <scholar-quest-one
...
<script setup> 
    ...
    function startConvo1() {
        ...
        conditionalStore.conversationsScholar.convo1Started = true;        
    }
    function endConversation1() {
        anyConversation.value = false;
        conditionalStore.conversationsScholar.convo1Started = false;
        endConversations();
    }
