      ...
      <div class="flex justify-center">
        <div class="text-center w-1/3 bg-white bg-opacity-90 flex justify-center">
            <div class="py-8 font-semibold font-mono ">
                <p class="">Hi!  Welcome to my shop. <br/> Please try not to touch anything. <br/> Some of my items are enchanted, and they can be temperamental. <br/> If you need any help, just ask!</p>
                <div class="pt-4"> 
              ...
              <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                <div>
                  ...
                  <div v-if="convoThread1" class="mt-3 text-center sm:mt-5">
                    <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-900">Sure.</DialogTitle>
                    <div class="mt-2">
                      <p class="text-sm text-gray-500">What do you want to know?</p>                    
                    </div>
                  </div>
          ...
          <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" enter-to="opacity-100 translate-y-0 sm:scale-100" leave="ease-in duration-200" leave-from="opacity-100 translate-y-0 sm:scale-100" leave-to="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
            <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
              <div>
                <!-- shopkeeper image -->
                <div class="mx-auto flex items-center justify-center rounded-full bg-green-100">
                  <img src="../../assets/images/village/Leather_Shopkeeper.png" alt="" class="" aria-hidden="true" />
                </div>                
                <!-- dialog -->
