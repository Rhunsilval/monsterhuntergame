      ...
      <div class="flex justify-center">
        <div class="text-center w-1/3 bg-white bg-opacity-95 flex justify-center">
            <div class="py-8 font-semibold font-mono ">
                <p class="">Welcome to my apothecary shop! <br/> Please have a look around. <br/> Let me know if you're looking for something in particular.</p>
                <div class="pt-4">  
            ...
            <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
              <div>
                ...
                <div v-if="convoThread2" class="mt-3 text-center sm:mt-5"> 
                  <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-900">I'm afraid so.</DialogTitle>
                  <div class="mt-2">
                    <p class="text-sm text-gray-500">Don't worry though! I'm working on making lots more.  Be sure to check back later!</p>
                  </div>
                </div>
              </div>              
              <!-- buttons -->
