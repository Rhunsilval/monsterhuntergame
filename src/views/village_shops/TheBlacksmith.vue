...
<!-- background -->
    <div class="bg-[url('../assets/images/village/Blacksmith_Shop.png')] bg-cover max-w-full  ">

<!-- header -->
      <div class="flex justify-center">
        <div class="text-center w-1/3 bg-white bg-opacity-90 flex justify-center">
            <div class="py-3 ">
                <p class="font-extrabold font-serif text-6xl ">Sally's Smithy Supplies</p>                
            </div>             
        </div>        
      </div>
...
<!-- shopkeeper -->
      <div class="flex justify-center">
        <div class="text-center w-1/3 bg-white bg-opacity-90 flex justify-center">
            <div class="pt-3 ">
                <img src="../../assets/images/village/Blacksmith_Shopkeeper.png" alt="" class="w-48 h-60 border border-black "/>                 
            </div>             
        </div>        
      </div>
      <div class="flex justify-center">
