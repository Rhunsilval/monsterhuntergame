          ...
          <div class="text-center w-1/3 bg-white bg-opacity-95 flex justify-center">
            <div class="grid grid-cols-1 pt-4"> 
                ...
                <div class="relative flex self-center rounded-lg p-0.5 pb-10 ">
                    <router-link :to="'/village2'" type="button" class="relative items w-1/2 whitespace-nowrap rounded-md border border-gray-600 bg-[#a6bf8e] hover:bg-green-100 py-2 text-sm font-medium text-gray-900 shadow-sm focus:z-10 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:w-auto sm:px-8">
