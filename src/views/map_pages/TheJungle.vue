...
<!-- landing screen -->
  <div v-if="!startGame">
    <div class="bg-[url('../assets/images/jungle/Jungle_background.png')] w-screen h-screen">
...
<!-- start hunt screen -->
  <div v-if="startGame">
    <div class="bg-[url('../assets/images/jungle/Jungle_background.png')] w-screen h-screen ">
      <div class="bg-opacity-60 bg-[#82bc71] w-screen h-screen">
              ...
              <div v-if="!monsterStore.monsterFound" class="grid grid-cols-2 items-center mb-28 ">  
                    ...
                    <div class=" flex flex-col justify-center items-center py-10 px-10"> 
                      <div v-if="!toggleImage"> 
                        <img src="../../assets/images/jungle/jungle_nomonster1.png" alt="" class="border border-black h-60  w-60 object-cover" />
                        <p>I found a bug, but no monster</p> 
                      </div>
                              
                      <div v-if="toggleImage"> 
                        <img src="../../assets/images/jungle/jungle_nomonster2.png" alt="" class="border border-black h-60 w-60 object-cover" />
...
<script>
  ...
  export default {
    ...
    emits: [],
    setup() {
      const mapName = 'The Moving Jungle';
